...
export default {
  ...
  biography:
    "I'm a Software Engineer currently focusing on building better UIs at <strong>Apple</strong> in Cupertino. I focus on designing and developing quality web, iOS, and macOS apps with <strong>React</strong>, <strong>Vue</strong>, <strong>Stencil</strong>, <strong>JavaScript</strong>, <strong>Swift</strong>, <strong>HTML</strong>,\n and <strong>CSS / SASS</strong>.",
  experience: [
    {
